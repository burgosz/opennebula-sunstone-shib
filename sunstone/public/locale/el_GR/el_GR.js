...
locale={
    ...
    "Please, choose and modify the virtual network you want to update":"Παρακαλώ, επιλέξτε και παραμετροποιήστε το εικονικό δίκτυο που θέλετε να ενημερώσετε",
    "Select a network":"Επιλέξτε ένα δίκτυο",
