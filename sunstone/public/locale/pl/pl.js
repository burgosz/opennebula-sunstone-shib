...
locale={
    ...
    "The OpenNebula Ceph pool name. Defaults to \"one\" (this pool must exist before using the drivers).":"Nazwa puli Ceph. Domyślną nazwą jest \"one\" (pula musi być utworzona zanim użyte zostaną sterowniki).",
    ...
    "Providers":"Dostawcy",
    "Zone ID":"ID strefy",
    "Assign physical resources":"Przydziel fizyczne zasoby",
    "For each OpenNebula Zone, you can assign cluster resources (set of physical hosts, datastores and virtual networks) to this group.":"Dla każdej strefy OpenNebula można przydzielić zasoby klastra (grupę fizycznych gospodarzy, magazynów danych oraz sieci wirtualnych) dla tej grupy.",
    "Select clusters":"Wybierz klastry",
